...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTPHEADER => array(
    "authorization: ufvcJ1xCtE2n0FYbeZhIOa9zK58jAPDMWsgd67wVlpyH4QmS3qumJ4t0sjD2Ofg5c87CKTkwyZHNdV6Y",
    "accept: */*",
...
<body>
    ...
    <div class=" container mt-5">
        ...
        <form action="" method="post" class="mt-5">
            ...
            <input class="form-control me-2" type="search" placeholder="Enter otp" aria-label="Search">
        </form>
...
function showPosition(position) {
  ...
  "<br>Longitude: " + position.coords.longitude+"<br>nearest hospital bed has been booked"
  ;
}
</script>
<br>